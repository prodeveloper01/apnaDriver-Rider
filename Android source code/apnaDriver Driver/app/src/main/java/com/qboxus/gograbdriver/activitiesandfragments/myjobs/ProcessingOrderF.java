...
public class ProcessingOrderF extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    View view;
    ArrayList<MyOrdersModel> dataList = new ArrayList<>();
    ...
    /*
      This method will call the api "showRiderOrders" to fetch the active order of rider.
    */
                ...
                if (resp != null) {
                    try {
                        ...
                        if (respobj.getString("code").equals("200")) {
                            ...
                            Functions.orderParseData(jsonArray_PendingOrders, "Active", arrayList -> {
                                if (pageCount == 0) {
                                    dataList.clear();
                                }
